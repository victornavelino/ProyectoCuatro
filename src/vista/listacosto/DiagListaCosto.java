 ...
 * @author AFerSor
 */
public class DiagListaCosto<T> extends javax.swing.JDialog {

    private List<T> lstGenerico;
    private Class<T> entidad;

    public DiagListaCosto(java.awt.Frame parent, boolean modal, String titulo, String subTitulo, Class<T> entidad) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jlSubTitulo.setText("Tipo de Listas de Costo");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DiagListaCosto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DiagListaCosto dialog = new DiagListaCosto(new javax.swing.JFrame(), true, "", "", null);
    ...
    public class EventoBoton implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            switch (this.tipoOperacion) {
                ...
                case 0:
                    dgE = new DiagListaCostoEdit(this.jdPadre, Boolean.TRUE, titulo, "  Nuevo", this.entidad);

                    break;
                case 1://Modificar
                    if (jTable.getSelectedRow() != -1) {
                    dgE = new DiagListaCostoEdit(this.jdPadre, Boolean.TRUE, titulo, "  Modificar", this.entidad);
                ...
                case 2://Eliminar
                    if (jTable.getSelectedRow() != -1) {
                        dgE = new DiagListaCostoEdit(this.jdPadre, Boolean.TRUE, titulo, "  Eliminar", this.entidad);
