...
public class DiagAdministrarMovimientosInternos extends javax.swing.JDialog {
    ...
    private void traerDatos() {
        ...
        if (this.sucursal.getNombre().equals("CENTRAL")) {
            if (cmbSucursal.getSelectedIndex() > -1) {
    ...
    public void cargarTabla(List<MovimientoInterno> datos) {
        ...
        for (int i = 0; i < datos.size(); i++) {
            ...
            fila[0] = datos.get(i).getNumeroLote();
            fila[1] = datos.get(i).getNumero();
            fila[2] = formato.format(datos.get(i).getFecha());
            fila[3] = datos.get(i).getTipoDeMovimiento();
            fila[4] = datos.get(i).getIdTransformado();
            fila[5] = datos.get(i).getArticuloCodigo();
            fila[6] = datos.get(i).getArticuloDescripcion();
            fila[7] = datos.get(i).getMonto();
            fila[8] = datos.get(i).getCantidad();
            fila[9] = datos.get(i).getCantidad().
                    multiply(datos.get(i).getMonto()).setScale(2, BigDecimal.ROUND_CEILING);
            fila[10] = datos.get(i).getEstado().toUpperCase();
            fila[11] = datos.get(i).getSucursal();
            fila[12] = datos.get(i).getSucursalDestino();
    ...
    private void eliminarMovimientoInterno() {
        ...
        MovimientoInterno movi = datos.get(numFila);
    ...
    private void reimprimir() {
        ...
        // que es lo único que se debe imprimir
    ...
    private void recepcionarMovimientoInterno() {
        DiagRecepcionMovimientoInterno recepcionMovimientoInterno
                = new DiagRecepcionMovimientoInterno(null, true, this.usuario, this.sucursal, (int) tblDatos.getValueAt(tblDatos.getSelectedRow(), 0));
    ...
    private void verificarSeleccion() {
        ...
        if (tblDatos.getSelectedRows().length > 0) {
            ...
            if (tblDatos.getValueAt(tblDatos.getSelectedRow(), 3).equals("ING")
                    && tblDatos.getValueAt(tblDatos.getSelectedRow(), 10).equals("ABIERTO")) {
