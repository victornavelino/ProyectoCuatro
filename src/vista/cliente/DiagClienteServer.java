...
public class DiagClienteServer extends javax.swing.JDialog {
    ...
    private void modificarPersona() {
        if (tblPersonas.getSelectedRow() != -1) {
            Cliente persona = ClienteFacade.getInstance().getPersonasXId((Long) tblPersonas.getValueAt(tblPersonas.getSelectedRow(), 0));
    ...
    private void eliminarPersona() {
        if (tblPersonas.getSelectedRow() != -1) {
            ...
            if (i == 0) {
                ...
                Cliente cliente = ClienteFacade.getInstance().getPersonasXId((Long) tblPersonas.getValueAt(tblPersonas.getSelectedRow(), 0));
