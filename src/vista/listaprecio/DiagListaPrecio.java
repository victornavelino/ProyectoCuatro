 ...
 * @author AFerSor
 */
public class DiagListaPrecio<T> extends javax.swing.JDialog {

    private List<T> lstGenerico;
    private Class<T> entidad;

    public DiagListaPrecio(java.awt.Frame parent, boolean modal, String titulo, String subTitulo, Class<T> entidad) {
        super(parent, modal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DiagListaPrecio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DiagListaPrecio dialog = new DiagListaPrecio(new javax.swing.JFrame(), true, "", "", null);
        ...
        try {
            ...
            if (!lstGenerico.isEmpty()) {
                ...
                for (T a : lstGenerico) {
                    ...
                    //Margen
                    campo = entidad.getDeclaredMethod("getMargen", sinParametro);
                    objeto = campo.invoke(a, new Object[]{});
    ...
    public class EventoBoton implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            switch (this.tipoOperacion) {
                ...
                case 0:
                    dgE = new DiagListaPrecioEdit(this.jdPadre, Boolean.TRUE, titulo, "  Nuevo", this.entidad);
